function initCountryCode(targetClass) {
    ...
    $.each($('.country-code option'), function(i, option) {
        ...
        list.push('<li><a href="javascript:void(0)" class="jq-country-code" data-value="' + $option.val() + '" data-country="' + $option.data('country') + '" data-country-name="' + $option.data('country-name') + '"><span class="jq-flag-img"><img src="./images/country-flag/' + $option.data('country') + '.png"></span>' + '<span class="jq-country-code-number">' + $option.val() + '</span>' + $option.data('country-name') + '</a></li>');
    });
    $ul.append(list.join(""));
    ...
    }).html('<img src="./images/country-flag/' + selectedOption.data('country') + '.png" class="jq-selected-flag"><span class="jq-selected-country-code"> ' + selectedOption.val() + '</span> <span class="arrow-down"></span>');
